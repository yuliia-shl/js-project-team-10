...
height: 580px; src="${x}" srcset="${x} 1x, ${S} 2x" alt="Project 8" loading="lazy" class="project-img" />
  ...
  <picture>
    ...
    <source media="(min-width:320px)" srcset="${b} 1x, ${L} 2x" type="image/webp" />
    <img width: 1008px;
height: 580px src="${b}" srcset="${b} 1x, ${L} 2x" alt="Project 9" loading="lazy" class="project-img" />
  </picture>
          <p class="project-tech">React, JavaScript, Node JS, Git</p>
          <div class="tab-link-container">
  ...
  <picture>
    <source media="(min-width:1280px)" srcset="${we} 1x, ${je} 2x" type="image/webp" />
    <source media="(min-width:768px)" srcset="${xe} 1x, ${be} 2x" type="image/webp" />
    <source media="(min-width:320px)" srcset="${w} 1x, ${B} 2x" type="image/webp" />
    <img width: 1008px;
height: 580px; src="${w}" srcset="${w} 1x, ${B} 2x" alt="Project 10" loading="lazy" class="project-img" />
  </picture>
          <p class="project-tech">React, JavaScript, Node JS, Git</p>
          <div class="tab-link-container">
