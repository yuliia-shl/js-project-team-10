import{S as C,N as P,P as q,K as N,a as O,i as A,A as R}from"./assets/vendor-BFlcYqFY.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const s of a)if(s.type==="childList")for(const c of s.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&r(c)}).observe(document,{childList:!0,subtree:!0});function o(a){const s={};return a.integrity&&(s.integrity=a.integrity),a.referrerPolicy&&(s.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?s.credentials="include":a.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(a){if(a.ep)return;a.ep=!0;const s=o(a);fetch(a.href,s)}})();const f=document.getElementById("contactForm"),v=document.getElementById("email"),I=document.querySelector(".error-message");f.addEventListener("submit",function(t){t.preventDefault();const e={email:document.getElementById("email").value,comment:document.getElementById("message").value};fetch("https://portfolio-js.b.goit.study/api/requests",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}).then(o=>{if(!o.ok)throw new Error(`HTTP error! Status: ${o.status}`);return o.json()}).then(o=>{o.title&&o.message?(document.querySelector("#successPopup h3").textContent=o.title,document.querySelector("#successPopup p").textContent=o.message,document.getElementById("successPopup").style.display="flex",f.reset()):document.getElementById("errorPopup").style.display="flex"}).catch(o=>{console.error("Error:",o),document.getElementById("errorPopup").style.display="flex",document.getElementById("email").value=e.email,document.getElementById("message").value=e.comment})});document.querySelectorAll(".close-btn").forEach(t=>{t.addEventListener("click",function(){t.closest(".popup").style.display="none"})});document.querySelectorAll(".popup").forEach(t=>{t.addEventListener("click",function(e){e.target===t&&(t.style.display="none")})});document.addEventListener("keydown",function(t){t.key==="Escape"&&document.querySelectorAll(".popup").forEach(e=>{e.style.display="none"})});v.addEventListener("input",function(){v.validity.valid?I.style.display="none":I.style.display="block"});document.addEventListener("DOMContentLoaded",J);const n={swiper:document.querySelector(".reviews-container"),swiperNext:document.querySelector(".review-button-next"),swiperPrev:document.querySelector(".review-button-prev"),reviewsList:document.querySelector(".reviews-list")},l=new C(n.swiper,{grabCursor:!0,direction:"horizontal",autoplay:{delay:1e3,disableOnInteraction:!1,pauseOnMouseEnter:!0},slidesPerView:1,spaceBetween:16,breakpoints:{768:{slidesPerView:1},1280:{slidesPerView:2,spaceBetween:32}},modules:[P,q,N],navigation:{nextEl:n.swiperNext,prevEl:n.swiperPrev},keyboard:{enabled:!0,onlyInViewport:!0}});async function V(){const t=await O.get("https://portfolio-js.b.goit.study/api/reviews");if(t.status!==200)throw new Error(`Request failed with status ${t.status}`);return t.data}let T=!1;async function J(){try{const e=(await V()).map(({author:o,avatar_url:r,review:a})=>`<li class="reviews-list-item swiper-slide" id="style-15">
                    <p class="reviews-text">${a}</p>
                    <div class="reviewer-info">
                        <img class="reviewers-avatar" src="${r}" alt=" ${o}'s photo" loading="lazy" />
                        <h3 class="reviewers-name">${o}</h3>
                    </div>
                </li>`).join("");n.reviewsList.insertAdjacentHTML("beforeend",e)}catch(t){T=!0,l.params.breakpoints[1280].slidesPerView=1,l.params.breakpoints[1280].spaceBetween=16,l.update(),console.dir(l.params.breakpoints),n.reviewsList.insertAdjacentHTML("beforeend",'<li class="error-mock"><p>We could not find what you are looking for.</p></li>'),console.error("Error fetching or rendering reviews:",t)}}function G(){T&&A.error({message:"No reviews were found! Please try again later.",position:"bottomRight"})}const z=new IntersectionObserver(t=>{t.forEach(e=>{e.isIntersecting&&G()})});z.observe(n.swiper);const H=()=>{const t=document.querySelector(".js-menu-container"),e=document.querySelector(".js-open-menu"),o=document.querySelector(".js-close-menu"),r=()=>{const c=t.querySelectorAll('a[href*="#"]'),m=e.getAttribute("aria-expanded")==="true"||!1;if(e.setAttribute("aria-expanded",!m),t.classList.toggle("is-open"),c.length!==0){if(!m){c.forEach(p=>{p.addEventListener("click",r)});return}c.forEach(p=>{p.removeEventListener("click",r)})}};e.addEventListener("click",r),o.addEventListener("click",r),window.matchMedia("(min-width: 375px)").addEventListener("change",c=>{c.matches&&(t.classList.remove("is-open"),e.setAttribute("aria-expanded",!1))});const a=document.getElementById("switch"),s=document.getElementById("favicon");a.addEventListener("change",()=>{document.body.classList.toggle("dark-theme"),document.body.classList.contains("dark-theme")?(localStorage.setItem("theme","dark"),s.href="/js-project-team-10/favicon-dark.ico"):(localStorage.setItem("theme","light"),s.href="/js-project-team-10/favicon.ico")}),localStorage.getItem("theme")==="dark"?(document.body.classList.add("dark-theme"),a.checked=!0,s.href="/js-project-team-10/favicon-dark.ico"):s.href="/js-project-team-10/favicon.ico"};document.addEventListener("DOMContentLoaded",function(){const t=document.body,e=document.querySelector(".js-open-menu"),o=document.querySelector(".js-close-menu"),r=document.getElementById("mobile-menu"),a=document.querySelectorAll(".header-mobile-link");e.addEventListener("click",function(){r.classList.add("active"),t.style.overflow="hidden",e.setAttribute("aria-expanded","true")}),o.addEventListener("click",function(){r.classList.remove("active"),t.style.overflow="auto",e.setAttribute("aria-expanded","false")}),a.forEach(s=>{s.addEventListener("click",function(){t.style.overflow="auto",r.classList.remove("active"),e.setAttribute("aria-expanded","false")})}),document.addEventListener("click",function(s){!r.contains(s.target)&&!e.contains(s.target)&&(r.classList.remove("active"),e.setAttribute("aria-expanded","false"))})});new R(".faq-ac-container",{openOnInit:[0],collapse:!0,elementClass:"faq-ac",triggerClass:"faq-ac-trigger",panelClass:"faq-ac-panel"});const i="/js-project-team-10/assets/icons-B8RZkLtE.svg",d="/js-project-team-10/assets/my-project-4-mob_1x-CaZrrZ4L.webp",_="/js-project-team-10/assets/my-project-4-mob_2x-Dsi_fBJN.webp",W="/js-project-team-10/assets/my-project-4-tab_1x-Bm4HUelK.webp",F="/js-project-team-10/assets/my-project-4-tab_2x-C_rSt4TV.webp",Y="/js-project-team-10/assets/my-project-4-desk_1x-B_EbEvoG.webp",K="/js-project-team-10/assets/my-project-4-desk_2x-CT56BrZF.webp",u="/js-project-team-10/assets/my-project-5-mob_1x-C-FqkT_n.webp",E="/js-project-team-10/assets/my-project-5-mob_2x-D_lBFHrP.webp",Z="/js-project-team-10/assets/my-project-5-tab_1x-DY1MIwHu.webp",U="/js-project-team-10/assets/my-project-5-tab_2x-CA6TLo5f.webp",X="/js-project-team-10/assets/my-project-5-desk_1x-D8ZaSk76.webp",Q="/js-project-team-10/assets/my-project-5-desk_2x-Byw1lDZs.webp",h="/js-project-team-10/assets/my-project-6-mob_1x-BKMi80tp.webp",k="/js-project-team-10/assets/my-project-6-mob_2x-BZr_msEn.webp",ee="/js-project-team-10/assets/my-project-6-tab_1x-GgBQYr0M.webp",te="/js-project-team-10/assets/my-project-6-tab_2x-BXnbLvWP.webp",se="/js-project-team-10/assets/my-project-6-desk_1x-DCmBPE18.webp",ae="/js-project-team-10/assets/my-project-6-desk_2x--X3-j-ey.webp",g="/js-project-team-10/assets/my-project-7-mob_1x-0-0e4ZQT.webp",$="/js-project-team-10/assets/my-project-7-mob_2x-DwkD79fv.webp",oe="/js-project-team-10/assets/my-project-7-tab_1x-C84u-3nB.webp",re="/js-project-team-10/assets/my-project-7-tab_2x-DeSCEq0d.webp",ce="/js-project-team-10/assets/my-project-7-desk_1x-C8xhJxg1.webp",ie="/js-project-team-10/assets/my-project-7-desk_2x-CC_ezROz.webp",x="/js-project-team-10/assets/my-project-8-mob_1x-ByoW_oVT.webp",S="/js-project-team-10/assets/my-project-8-mob_2x-CaI7-QGM.webp",ne="/js-project-team-10/assets/my-project-8-tab_1x-DgB_lU8O.webp",pe="/js-project-team-10/assets/my-project-8-tab_2x-DeV4Xxri.webp",me="/js-project-team-10/assets/my-project-8-desk_1x-BBvz8kpI.webp",le="/js-project-team-10/assets/my-project-8-desk_2x-CPkKKTsW.webp",j="/js-project-team-10/assets/my-project-9-mob_1x-D-cVnVu7.webp",L="/js-project-team-10/assets/my-project-9-mob_2x-Dgq8Yv0C.webp",de="/js-project-team-10/assets/my-project-9-tab_1x-Vrq7X7tk.webp",ue="/js-project-team-10/assets/my-project-9-tab_2x-bNxU0I4l.webp",he="/js-project-team-10/assets/my-project-9-desk_1x-B6OWfVZ3.webp",ge="/js-project-team-10/assets/my-project-9-desk_2x-D8rB3lnd.webp",b="/js-project-team-10/assets/my-project-10-mob_1x-BdpK2UYi.webp",B="/js-project-team-10/assets/my-project-10-mob_2x-CjX_wIUa.webp",xe="/js-project-team-10/assets/my-project-10-tab_1x-BafFCe4R.webp",je="/js-project-team-10/assets/my-project-10-tab_2x-DJ587m_0.webp",be="/js-project-team-10/assets/my-project-10-desk_1x-Dh7zn3mI.webp",we="/js-project-team-10/assets/my-project-10-desk_2x-CkzGHwxJ.webp";document.addEventListener("DOMContentLoaded",()=>{const t=document.querySelector(".load-more"),e=document.querySelector(".project-list");let o=[`<li class="project-item">
      <picture>
        ...
        <img width: 1008px; height: 580px src="${d}" srcset="${d} 1x, ${_} 2x" alt="Project 4" loading="lazy" class="project-img" />
      </picture>
      ...
      <picture>
        ...
        <img width: 1008px; height: 580px; src="${g}" srcset="${g} 1x, ${$} 2x" alt="Project 7" loading="lazy" class="project-img" />
      </picture>
      <p class="project-tech">React, JavaScript, Node JS, Git</p>
      <div class="tab-link-container">
      ...
      <picture>
        ...
        <img width: 1008px; height: 580px; src="${x}" srcset="${x} 1x, ${S} 2x" alt="Project 8" loading="lazy" class="project-img" />
      </picture>
      <p class="project-tech">React, JavaScript, Node JS, Git</p>
      <div class="tab-link-container">
      ...
      <picture>
        ...
        <img width: 1008px; height: 580px src="${j}" srcset="${j} 1x, ${L} 2x" alt="Project 9" loading="lazy" class="project-img" />
      </picture>
      <p class="project-tech">React, JavaScript, Node JS, Git</p>
      <div class="tab-link-container">
      ...
      </li>`],r=0;t.addEventListener("click",a=>{a.preventDefault();const s=o.slice(r,r+3);if(s.length>0){e.children[e.children.length-1],s.forEach(p=>{const y=document.createElement("template");y.innerHTML=p.trim();const M=y.content.firstChild;e.appendChild(M)});const m=e.children[r].getBoundingClientRect().height;window.scrollBy({top:m*.6,behavior:"smooth"}),r+=s.length}r>=o.length&&(t.style.display="none")})});const w=document.getElementById("backToTop");window.addEventListener("scroll",()=>{window.scrollY>window.innerHeight*.75?w.style.display="flex":w.style.display="none"});function D(){const e=window.scrollY;e>0&&(window.scrollTo(0,e-e*1),requestAnimationFrame(D))}w.addEventListener("click",D);H();
